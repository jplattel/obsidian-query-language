...
var FuseSearchIndex = /** @class */ (function () {
    ...
    FuseSearchIndex.prototype.buildIndex = function (files) {
        ...
        var markdownFiles = files.map(function (markdownFile) {
            return {
    ...
    FuseSearchIndex.prototype.search = function (query) {
        ...
        return this.searchIndex.search(query).map(function (searchResult) {
...
var QueryResultRenderer = /** @class */ (function () {
    ...
    QueryResultRenderer.renderLink = function (markdownFileResult) {
    ...
    QueryResultRenderer.renderString = function (searchResults, nodeConfig) {
        ...
        var output = nodeConfig.template;
    ...
    QueryResultRenderer.renderList = function (searchResults, nodeConfig) {
        ...
        searchResults.forEach(function (markdownFileResult) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (this.app.workspace.layoutReady) {
                    ...
                    this.registerEvent(this.app.vault.on("modify", this.rebuildIndex.bind(this)));
                }
                return [2 /*return*/];
            });
        });
